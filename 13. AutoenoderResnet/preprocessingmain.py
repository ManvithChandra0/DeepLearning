from models import AutoencoderResNet
...
def autoencoder_call():
    # Create an instance of the AutoencoderResNet class
    autoen = AutoencoderResNet()
    ...
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.title('Training and Validation Loss AutoenoderResnet')
    plt.legend()
    plt.show()
